...
function renderNav() {
    ...
    nav.innerHTML = `
        ...
        <div class="nav-items">
            ...
            <a href="/static/score.html" class="nav-item ${page === 'score' ? 'active' : ''}">
            ...
            <a href="/static/review.html" class="nav-item ${page === 'review' ? 'active' : ''}">
            ...
            <a href="/static/gap-report.html" class="nav-item ${page === 'gap-report' ? 'active' : ''}">
